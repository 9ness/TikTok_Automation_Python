...
export default function CarruselesPage() {
   ...
   *  mirar cuál va antes. */
  /** Las fotos editadas de la carpeta, en el orden en que se publican: la 1 y
   *  la 2 del primer producto, luego las del segundo… Se recorren TODOS los
      ...
      <section className="space-y-2">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-1.5">
            ...
            >
              <span className="break-words leading-tight">🖼️ Listos {listos}/{aptos.length}</span>
            </div>
            <button
              type="button"
              onClick={() => setVerEscaparate(true)}
              className="flex items-center justify-center gap-1.5 break-words leading-tight rounded-lg border border-sky-500/50 bg-sky-500/10 px-2 py-1.5 text-[11px] font-semibold text-sky-500 transition hover:bg-sky-500/20"
            >
              <span className="break-words leading-tight">🏪 Escaparate</span>
            </button>
          </div>
        </Paso>
