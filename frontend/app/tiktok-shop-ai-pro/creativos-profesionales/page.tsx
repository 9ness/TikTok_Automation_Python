      ...
      <section className="space-y-2">
        ...
        >
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-1.5 rounded-lg border border-violet-500/50 bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 px-3 py-2 text-xs font-semibold text-violet-400 transition hover:border-violet-400 hover:from-violet-500/30 hover:to-fuchsia-500/30 disabled:opacity-50"
          >
