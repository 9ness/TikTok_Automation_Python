...
def enqueue_presidents(
    ...
    for item in payload.items:
        ...
        params: dict[str, Any] = {
            ...
            "numbers_header_mode": payload.numbers.header_mode,
            "numbers_header_duration": payload.numbers.header_duration,
            "numbers_header_animation": payload.numbers.header_animation,
            ...
            "numbers_number_medal_colors": payload.numbers.number_medal_colors,
            "numbers_number_color_gold": payload.numbers.number_color_gold,
            "numbers_number_color_silver": payload.numbers.number_color_silver,
            "numbers_number_color_bronze": payload.numbers.number_color_bronze,
