"""Wrapper Upstash REST especializado para Nicho Carruseles (`nicho_carruseles:`).
...
from src.nicho_carruseles.config import REDIS_PREFIX


class NichoCarruselesRedis:
    """Cliente Redis con prefijo `nicho_carruseles:` por defecto.
    ...
    def _get(self, path: str, *, timeout: float = 10) -> Any:
        ...
        try:
            ...
            print(f"[NichoCarruselesRedis] GET {path} error: {e}")
            return None
    ...
    def _post(self, path: str, body: bytes | None = None, *, timeout: float = 10) -> Any:
        ...
        try:
            ...
            print(f"[NichoCarruselesRedis] POST {path} error: {e}")
            return None
...
# Singleton perezoso
_INSTANCE: NichoCarruselesRedis | None = None


def get_nicho_carruseles_redis() -> NichoCarruselesRedis:
    global _INSTANCE
    if _INSTANCE is None:
        _INSTANCE = NichoCarruselesRedis()
    return _INSTANCE
