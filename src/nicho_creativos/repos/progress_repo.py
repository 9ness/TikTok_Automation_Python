...
Key: `nicho_creativos:completed:<source>` → SET de nombres de carpeta.
...
# ---------------------------------------------------------------------------
# Carpetas con los creativos hechos pero SIN subir todavía
# ---------------------------------------------------------------------------
# SET propio, no un flag dentro de las completadas: se preparan creativos de
# días futuros y esa carpeta no está cerrada —queda por subirlos—, y una ya
# cerrada puede seguir sin subir. Mismo esquema que en el Nicho POV BOF.
