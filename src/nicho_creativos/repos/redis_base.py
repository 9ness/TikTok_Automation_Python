"""Wrapper Upstash REST especializado para Nicho Creativos Pro (`nicho_creativos:`).
...
from src.nicho_creativos.config import REDIS_PREFIX


class NichoCreativosRedis:
    """Cliente Redis con prefijo `nicho_creativos:` por defecto.
    ...
    def _get(self, path: str, *, timeout: float = 10) -> Any:
        ...
        try:
            ...
            print(f"[NichoCreativosRedis] GET {path} error: {e}")
            return None
    ...
    def _post(self, path: str, body: bytes | None = None, *, timeout: float = 10) -> Any:
        ...
        try:
            ...
            print(f"[NichoCreativosRedis] POST {path} error: {e}")
            return None
...
# Singleton perezoso
_INSTANCE: NichoCreativosRedis | None = None


def get_nicho_creativos_redis() -> NichoCreativosRedis:
    global _INSTANCE
    if _INSTANCE is None:
        _INSTANCE = NichoCreativosRedis()
    return _INSTANCE
