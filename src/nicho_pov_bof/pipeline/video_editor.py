...
def _render_plano_png(
    ...
    partes = [im for im in (f() for f in orden) if im is not None]
    if not partes:
        return None
...
_PALETAS = (
    ...
    # invierno se añaden las suyas y estas se apagan solas.
    {
        "nombre": "calabaza",
        "estacion": "otoño",
        "gancho_fill": (255, 255, 255), "gancho_glow": (255, 124, 16),
        "cta_fill": (255, 236, 190),    "cta_glow": (214, 78, 8),
        "tono": 26, "familias": "🎃🍁💸🔥🏷️",
    },
    {
        "nombre": "mostaza",
        "estacion": "otoño",
        "gancho_fill": (255, 255, 255), "gancho_glow": (255, 190, 30),
        "cta_fill": (255, 246, 190),    "cta_glow": (200, 128, 10),
        "tono": 46, "familias": "🤑💳🏷️🌾🥮",
    },
    {
        "nombre": "oliva",
        "estacion": "otoño",
        "gancho_fill": (238, 255, 214), "gancho_glow": (154, 205, 50),
        "cta_fill": (255, 255, 255),    "cta_glow": (96, 150, 26),
        "tono": 78, "familias": "🌰🍐🧺✅🔖",
    },
    {
        "nombre": "bosque",
        "estacion": "otoño",
        "gancho_fill": (255, 255, 255), "gancho_glow": (32, 208, 130),
        "cta_fill": (216, 255, 236),    "cta_glow": (16, 150, 96),
        "tono": 158, "familias": "🌲🍀🌿♻️💚",
    },
    {
        "nombre": "petroleo",
        "estacion": "otoño",
        "gancho_fill": (222, 246, 255), "gancho_glow": (0, 186, 224),
        "cta_fill": (255, 255, 255),    "cta_glow": (0, 132, 176),
        "tono": 198, "familias": "🌧️🧊💧👀🔎",
    },
    {
        "nombre": "ciruela",
        "estacion": "otoño",
        "gancho_fill": (255, 255, 255), "gancho_glow": (190, 92, 232),
        "cta_fill": (246, 224, 255),    "cta_glow": (140, 56, 190),
        "tono": 288, "familias": "🍇🔮💜🎟️✨",
    },
    {
        "nombre": "vino",
        "estacion": "otoño",
        "gancho_fill": (255, 255, 255), "gancho_glow": (232, 56, 92),
        "cta_fill": (255, 214, 196),    "cta_glow": (184, 30, 64),
        "tono": 348, "familias": "🍷🧣💰🥀❤️",
    },
)
