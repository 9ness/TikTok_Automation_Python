"""Wrapper Upstash REST especializado para Nicho POV BOF Largo (`nicho_pov_bof_largo:`).
...
from src.nicho_pov_bof_largo.config import REDIS_PREFIX


class NichoPovBofLargoRedis:
    """Cliente Redis con prefijo `nicho_pov_bof_largo:` por defecto.
    ...
    def _get(self, path: str, *, timeout: float = 10) -> Any:
        ...
        try:
            ...
            print(f"[NichoPovBofLargoRedis] GET {path} error: {e}")
            return None
    ...
    def _post(self, path: str, body: bytes | None = None, *, timeout: float = 10) -> Any:
        ...
        try:
            ...
            print(f"[NichoPovBofLargoRedis] POST {path} error: {e}")
            return None
...
# Singleton perezoso
_INSTANCE: NichoPovBofLargoRedis | None = None


def get_nicho_pov_bof_largo_redis() -> NichoPovBofLargoRedis:
    global _INSTANCE
    if _INSTANCE is None:
        _INSTANCE = NichoPovBofLargoRedis()
    return _INSTANCE
