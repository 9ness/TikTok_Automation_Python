<!-- "MOF 10 SEGUNDOS · frente a espejo" (HOMBRE), paso 1 de 2: la IMAGEN, en
     Flow con la foto de la prenda como referencia.

     Literal de su web. La versión de mujer es OTRO fichero, también suyo: no
     se derivan, porque entre las dos cambian cosas que no son el género
     (maquillaje, joyería) y el guion es directamente otro texto. -->

{
  "subject": {
    "description": "A random young man of any appearance, with any hair type, length, color, and texture, any body type, any skin tone, any age between 18 and 35, standing barefoot in front of a random type of mirror inside a random indoor setting. He is taking a mirror selfie, holding a smartphone in one hand while the other hand is in any natural position. His full body is visible from head to toe, standing with any relaxed or natural posture.",
  ...
  "face": {
    "makeup": "none, natural skin texture, clean-shaven or light stubble, realistic skin texture"
  },
  "accessories": {
