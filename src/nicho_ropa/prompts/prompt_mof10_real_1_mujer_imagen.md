<!-- "SITUACIÓN REAL 1" (mujer), paso 1 de 2: la IMAGEN, que se hace en Flow
...

{
  ...
  "clothing": {
    ...
    "instructions": [
      ...
      "Adapt the outfit naturally to the female body without altering its original design or proportions.",
      ...
      "The outfit is the only fixed visual element. The young woman and the street must be different and random in each generation."
    ]
  },
  "face": {
