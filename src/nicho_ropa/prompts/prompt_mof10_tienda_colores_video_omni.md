<!-- "TIENDA COLORES", CLIP 1 (8 s) con la edición hecha por el propio
     generador: los cortes de color los hace él, con la imagen 1 en cada
     color adjunta como INGREDIENTE (la del color puesto, la última). Con
     ...
     `{{GESTO}}`, `{{FINAL_GESTO}}`, `{{DETALLE_1}}` y `{{DETALLE_2}}` los
     rellena `config.con_familia` según el tipo de prenda: solo los
     pantalones se los suben, un jersey se tira del bajo y un cárdigan se
     abre (medido en diez virales). -->
