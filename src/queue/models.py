...
class JobMode(str, Enum):
    ...
    NICHO_ROPA_GUIONES = "nicho_ropa_guiones"
    NICHO_ROPA_TEXTOS = "nicho_ropa_textos"
...
MODE_LABELS = {
    ...
    JobMode.NICHO_ROPA_GUIONES: "✍️ Guiones Nicho Ropa",
    JobMode.NICHO_ROPA_TEXTOS: "🔤 Textos Nicho Ropa",
