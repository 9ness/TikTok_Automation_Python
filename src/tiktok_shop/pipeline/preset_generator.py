...
def _sensitive_apparel_block(product: Any) -> str:
    ...
    return (
        ...
        "comodidad. Pose neutra (de pie, caminando), NADA insinuante.\n"
        "- AMBIENTE: una CASA NORMAL / lifestyle de hogar (dormitorio, salón, "
        "junto a la cama, pasillo) con luz natural suave de ventana. NO uses "
        "fondo de estudio blanco — busca un escenario doméstico realista, como "
        "alguien en ropa cómoda por casa.\n"
        ...
        "  → \"Tasteful commercial activewear/loungewear advertisement, fit "
        "model wearing one single colour of the garment from the product photo, "
        "relaxing at home in a realistic everyday house setting (bedroom or "
        "living room) with soft natural window light, shown from the waist down "
        "or mid-torso with the face out of frame, focus on the fit and fabric, "
        "neutral confident pose, fully non-sexual, non-explicit, modest, no "
        "nudity.\"\n"
    )
