...
- [ ] **Probar la APK nueva (WebView) en el móvil**: instalarla encima de la que hay, volver a entrar con el PIN, y comprobar (a) que las descargas siguen cayendo en `Download/TTShopAIPro/` con su nombre y sus tildes, (b) que subir los clips de varios productos aguanta con el móvil bloqueado, y (c) los CARRUSELES, que es lo único que va por `blob:` y no se probó con tandas grandes. Avisar a Ana y a Mauro de que tienen que reinstalar y volver a entrar.
- [ ] **Magnific — spaces que faltan**: ya enlazados los 4 que existen (foto limpia→vídeo normal/plazos, foto con IA→vídeo, carrusel de 1 foto) en POV BOF, POV BOF Largo y Creativos Pro (`components/tiktok-shop-ai-pro/MagnificSpaces.tsx`). Pendiente: pasar las URLs de los spaces de los demás nichos (ropa con/sin personas, cine, gorras, cuenta piloto) cuando se creen, y decidir si Ana y Mauro acaban usando el de "foto con IA" (hoy solo lo ve el admin).
